            ...
            <div className="container">
                <div className="row">
                    <div className="col-md-4">
                        <Link to="/about">
                            <svg width="250px" height="250px" viewBox="0 0 16 16" className="bi bi-file-person" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="col-md-4">
                        <Link to="/project">
                            <svg width="250px" height="250px" viewBox="0 0 16 16" className="bi bi-file-richtext" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="col-md-4">
                        <Link to="/contact">
                            <svg width="250px" height="250px" viewBox="0 0 16 16" className="bi bi-chat-right-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
