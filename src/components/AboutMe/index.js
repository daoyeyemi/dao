            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-md-8">
                            ...
                            <p id="bio">
                                My name is David Oyeyemi and I am a full-stack software developer based 
                                in Carson, California. I'm all about improving and learning whilst challenging myself.
                                Let's work.
                            </p>
                    </div>
                </div>
